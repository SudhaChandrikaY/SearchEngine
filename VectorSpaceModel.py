...
# Defined a class for the VSM Implementation
class VectorSpaceModel:
    ...
    # Function for Document Indexing
    ...
    # Function that implements the query processing
    ...
    # Function to get the Document vectors
    ...
    # Function to get the query vector
    ...
    # Function to calculate and sort the cosine similarity scores
